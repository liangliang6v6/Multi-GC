...
# ppi ppi-large yelp dblp hg eg pcg ogbn-pro catalog youtube flickr-multi
parser.add_argument('--dataset', type=str, default='ogbn-pro')
parser.add_argument('--reduction_rate', type=float, default=0.0005)

parser.add_argument('--loss', type=str, default='M') # BCE OR OTHERS
